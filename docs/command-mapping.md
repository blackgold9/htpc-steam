...
| Volume | `volume_up/down`, `mute`, `mute_toggle`, `set_volume:N` | `wpctl set-volume`/`set-mute @DEFAULT_AUDIO_SINK@ ...` | **High** — PipeWire/wireplumber confirmed standard on SteamOS/Bazzite; not yet implemented (Phase 2) |
